...
Сам APK в репозитории не лежит: подписанные сборки публикуются в
[Releases](https://github.com/HippocampusEvolve/Snowfall/releases) — оттуда его и
берут для магазина. Локально он получается командой `npm run apk:release`.
